<template>
  <div class="privacy-policy">
    <div class="wrapper">
      <h1>Mocha Privacy Policy</h1>

      <h2>Mocha overview</h2>
      <p>
        Mocha is a moderation bot for Discord that allows server staff to
      ...
      <p>
        ...
        <a href="https://github.com/darthvadarhalo/MochaBot">
          https://github.com/darthvadarhalo/MochaBot
        </a>
      </p>

      <h2>Stored data</h2>
      <p>
        When Mocha is used by a server, the following categories data can be
        stored by the bot.
        The specific categories of data saved for each server depends on how the
        server has configured Mocha.
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>Infraction record data is kept until the server stops using Mocha
        ...
        <li>User information for users logged in to the bot's web dashboard via
          Discord OAuth is stored as long as the server uses Mocha
        </li>
      </ul>
