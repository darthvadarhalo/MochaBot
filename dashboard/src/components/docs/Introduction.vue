<template>
  <div>
    <h1>Introduction</h1>
    <p>
      Mocha is a private moderation bot for Discord, designed with large servers and reliability in mind.
    </p>
    ...
    <h2>Configuration</h2>
    <p>
      All Mocha configuration is done through the dashboard by editing a YAML config file. By default, only the server
    ...
    <h2>Plugins</h2>
    <p>
      Mocha is divided into plugins: grouped functionality that can be enabled/disabled as needed, and that have their own configurations.
    </p>
